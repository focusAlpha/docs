...
<Tip>
  Stuck? Email [jennifer@focusalpha.ai](mailto:jennifer@focusalpha.ai) and include the `requestId` from the error response — it lets us trace your exact request.
</Tip>
