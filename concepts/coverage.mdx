...
| Macro series (US, euro area, Japan, Taiwan; World Bank annual for every economy) | Daily; monthly and quarterly series on their release days | Decades, per series — read `coverage` on the series block; release dates from 2026-09-10 except the ten core US series, which carry every revision back to the 1950s |
| Economic calendar and consensus | Daily, including weekends | Schedule from 2013-01-02; consensus snapshots from 2026-09-09 |
