...
| How to get it | Sign up at [app.focusalpha.ai](https://app.focusalpha.ai) | Self-serve upgrade in [settings](https://app.focusalpha.ai/settings) | Sales-led — [talk to sales](https://focusalpha.ai/contact) |
...
| `GET /v1/etfs/taxonomy` | The four-level ETF classification vocabulary |
| `GET /v1/etfs/screen/facets` | ETF screener filter values and counts |
| `GET /v1/institutions/screen/facets` | Adviser screener filter values and counts |
...
| Professional and up | 13F institutional holdings, insider trades (Form 4), Taiwan financials and ownership, Korea (DART) financials, executive compensation and proxy ownership, short interest, daily prices and market caps, benchmarks, macroeconomic series and the economic calendar, the investment-adviser directory, Form 20-F datasets |
| Fund only | Cross-company screening, adviser screening, the ETF dataset — directory, NAV, shares, AUM, holdings, splits, distributions, fees, labels and screening, live news and events, structured 8-K events, 8-K exhibits, earnings-call guidance, reported earnings figures, prediction-market prices, international disclosures (TW/KR/JP), the venture-investor directory |
