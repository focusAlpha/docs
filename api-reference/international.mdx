...
These endpoints serve what companies file with their **own** markets — TWSE/TPEx in Taiwan, DART in Korea, TDnet in Japan — plus the SEC Form 20-F content of foreign private issuers. Local feeds and SEC filings are different datasets: a Taiwanese issuer that also files with the SEC appears in both, under different rules.
