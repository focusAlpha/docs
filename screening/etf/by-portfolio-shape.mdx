...
```bash cURL
curl "https://api.focusalpha.ai/v1/etfs/screen?segment=fixed_income.government.investment_grade&max_duration=2&min_treasury_share=0.9&max_expense_ratio=0.001" \
  ...
  "data": [
    {
      ...
      "segment": "fixed_income.government.investment_grade",
      "duration": 0.1,
      "treasury_share": 1.0,
      "n_holdings": 22,
