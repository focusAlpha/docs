...
```bash cURL
curl "https://api.focusalpha.ai/v1/screen?guidance_worse_since=2026-08-20&market_cap_usd_gte=10000000000&sort=market_cap_usd" \
...
```json Response (excerpt)
{
  "data": [
    {
      "company_id": "cmp_000972",
      "name": "Example Corp",
      "primary_ticker": "EXMP",
      "guidance_worse_90d": 2,
      "guidance_cuts_90d": 1,
      "guidance_last_worse_at": "2026-08-27",
