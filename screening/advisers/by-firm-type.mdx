...
```bash cURL
curl "https://api.focusalpha.ai/v1/institutions/screen?primary_type=asset_manager&subtype=quant_systematic&role_flags=acts_as_subadviser" \
