...
```bash cURL
curl "https://api.focusalpha.ai/v1/companies/NVDA/news?min_impact=60&limit=5" \
  ...
  "data": [
    {
      ...
      "title": "Nvidia data-center revenue tops estimates",
      "summary": "The chipmaker reported ...",
