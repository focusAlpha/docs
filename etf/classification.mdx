...
```json labels block (XBI)
{
  "labels": {
    ...
    "specializations": ["equity.sector.health_care.biotechnology"],
    "labels_as_of": { "holdings_as_of": "2026-08-03", "label_since": "2026-08-05" },
    "history": [],
    "declared": { "is_index": true, "multi_inverse": false }
  }
}
```
